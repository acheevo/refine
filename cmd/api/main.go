...
import (
	...
	adminservice "github.com/acheevo/refine/internal/admin/service"
	admintransport "github.com/acheevo/refine/internal/admin/transport"
	"github.com/acheevo/refine/internal/auth/repository"
	authservice "github.com/acheevo/refine/internal/auth/service"
	authtransport "github.com/acheevo/refine/internal/auth/transport"
	"github.com/acheevo/refine/internal/health/service"
	"github.com/acheevo/refine/internal/health/transport"
	"github.com/acheevo/refine/internal/http"
	infoservice "github.com/acheevo/refine/internal/info/service"
	infotransport "github.com/acheevo/refine/internal/info/transport"
	"github.com/acheevo/refine/internal/middleware"
	"github.com/acheevo/refine/internal/shared/bootstrap"
	"github.com/acheevo/refine/internal/shared/config"
	"github.com/acheevo/refine/internal/shared/database"
	"github.com/acheevo/refine/internal/shared/logger"
	userrepository "github.com/acheevo/refine/internal/user/repository"
	userservice "github.com/acheevo/refine/internal/user/service"
	usertransport "github.com/acheevo/refine/internal/user/transport"
)
